        ...
        form.on('submit(form)', function (data) {
            ...
            $.ajax({
                       ...
                       success: function (data) {
                           if (data == true) {
                               layer.msg('申请成功！', {anim: 3, icon: 6, time: 2000, shade: 0.1});
                               setTimeout(function () {
                                   // 关闭自身窗口
                               ...
                               layer.msg('已申请过，无需再次申请！', {anim: 6, icon: 5, time: 1500, shade: 0.1});
                           } else{
                               layer.msg('申请失败！', {anim: 6, icon: 5, time: 1500, shade: 0.1});
                           }
                       },
